...
for filename, ch in zip(filenames, ch_drive):
    command = f"rsync --bwlimit=25000 -rv --stats --progress -t /drives/{ch}/*/{filename} adamdong@fir.computecanada.ca:/home/adamdong/projects/rrg-istairs-ad/adamdong/bass_vdiff/"
